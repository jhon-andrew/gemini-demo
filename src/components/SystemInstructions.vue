...
const title = ref('Multi-turn conversations with System Instructions')
const md = markdownit()
...
const model = genAi.getGenerativeModel({
    ...
    systemInstruction: `You're a funny concierge at GDG Zamboanga's Google I/O Extended 2024 event that gives random facts about Google Technologies and AI in general.`
})
